...
class ScheduleCheckUpdateController
{
    ...
    public function noticeHasUpdate()
    {
        ...
        $message = 'There is a new update of Wilcity Theme or Wilcity\'s Plugins. Please click on <a href="'.
                   admin_url('admin.php?page=wilcity-service').'">Wilcity Service</a> to update it';
